...
public class ProductForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        String[] columnNames = { "Ảnh", "Tên sản phẩm", "Giá", "", ""};

        DefaultTableCellRenderer iconRenderer = new DefaultTableCellRenderer() {
            @Override
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column);
                ImageIcon iconTable = new ImageIcon("C:\\Users\\hgmin\\OneDrive\\Desktop\\study\\final_project_app\\src\\GUI\\icon\\" +value.toString() +".png");
            ...
            try {
                ArrayList<Product> products = connection.getList();
                for (Product product : products) {
                    Object[] object = {"home", product.getName(), product.getPrice(),"exit","home"};
            ...
            jTable1.getColumnModel().getColumn(0).setCellRenderer(iconRenderer);
            jTable1.getColumnModel().getColumn(3).setCellRenderer(iconRenderer);
            jTable1.getColumnModel().getColumn(4).setCellRenderer(iconRenderer);
